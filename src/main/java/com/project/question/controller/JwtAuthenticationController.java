...
import com.project.question.model.JwtRequest;
import com.project.question.model.JwtResponse;
...
public class JwtAuthenticationController {
	...
	public ResponseEntity<?> createAuthenticationToken(@RequestBody JwtRequest 
		...
		authenticate(authenticationRequest.getUsername().trim(), authenticationRequest.getPassword().trim());
